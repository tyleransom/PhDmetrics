...
One toy example that often appears in introductory econometrics textbooks is the effect of education on earnings. Typically, the textbook presents an equation like this:  $$\log\left(wage_{i}\right)=educ_{i}+\varepsilon_{i}$$ where $wage_i$ is the individual's wage as an adult, and $educ_i$ is the individual's years of completed education (e.g. 12 for a high school graduate, 16 for a college graduate, etc.).
